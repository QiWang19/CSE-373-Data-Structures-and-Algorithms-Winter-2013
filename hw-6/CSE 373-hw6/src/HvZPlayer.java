 ...
 */
public class HvZPlayer implements Comparable {
	...
	public boolean equals(Object o) {
		...
		if (this.getClass() == o.getClass()) {
			HvZPlayer copy = (HvZPlayer)o;
			return this.name.equals(copy.name) && this.human == copy.human && this.kills == copy.kills;
		}
		return false;
	}
	...
	public int hashCode() {
		...
		return 37 * Integer.valueOf(this.kills).hashCode() + Boolean.valueOf(this.human).hashCode() + this.name.hashCode();
	...
	public int compareTo(Object o) {
		HvZPlayer copy = (HvZPlayer)o;
		if (!this.name.equals(copy.name)) {
			return this.name.compareTo(copy.name);
		} else if (this.isHuman() != copy.isHuman()) {
			if (this.isHuman()) {
				return -1;
			} else if (copy.isHuman()){
				return 1;
			}
		} else {
			return this.kills - copy.kills;
		}
		return 0;
	}
}